package cn.edu.xmu.javaee.Lab5_SpringDataJPA.mapper.generator;
...
public class OnSalePoSqlProvider {
    ...
    protected void applyWhere(SQL sql, OnSalePoExample example, boolean includeExamplePhrase) {
        ...
        List<OnSalePoExample.Criteria> oredCriteria = example.getOredCriteria();
        boolean firstCriteria = true;
        for (int i = 0; i < oredCriteria.size(); i++) {
            OnSalePoExample.Criteria criteria = oredCriteria.get(i);
            if (criteria.isValid()) {
                if (firstCriteria) {
                    firstCriteria = false;
                } else {
                ...
                sb.append('(');
                List<OnSalePoExample.Criterion> criterions = criteria.getAllCriteria();
                boolean firstCriterion = true;
                for (int j = 0; j < criterions.size(); j++) {
                    OnSalePoExample.Criterion criterion = criterions.get(j);
                    if (firstCriterion) {
